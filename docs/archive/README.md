...
|---|---|
| `architecture-v2.md` | The rearchitecture rationale — why v2 is shaped this way. Not a description of current state; see its header for where to look for that. |
...
| `evidence-policy.md` | Rewritten 2026-08-03 as the data/privacy policy for the event store, gate spool, and memory files. It still carries the `missions/` never-tracked guard that CI enforces. |
...
| `examples-public-safe-mission.md` | The reference shape for a committed public mission record (was `docs/examples/missions/`). Mission records are agent-authored v1 artifacts; nothing in this repo generates or consumes them. |
