...
| Codex Mac App Distribution | Current alpha | Shipped / in review | DAN-180 dogfooding guide; DAN-192 one-command Codex setup; DAN-193 next alpha release | `README.md`, `docs/quickstart.md`, `docs/clean-install-uat.md`, `docs/dogfooding.md`, `scripts/install-codex-skill.sh`, `scripts/update-codex-skill.sh`, `missions/2026-05-22-1547-readme-codex-installer-flow.md` | Finish one-command setup review, run dogfooding, then prepare a clean reviewed next-alpha release. | Accepted: `codex-skill-installer`; README prompt, clean-install UAT, dogfooding, and one-command setup remain in review. |
...
| --- | --- | --- | --- | --- | --- |
| DAN-180 Create Dogfooding guide | In Progress | Current alpha | Codex Mac distribution and PRD faithfulness UAT | `docs/dogfooding.md`, `docs/clean-install-uat.md`, `docs/hyperagent-prd.md`, `docs/roadmap.md` | Use the guide for a two-week human dogfood pass from fresh install; fold repeated findings into issues, Workshop proposals, or release blockers. |
