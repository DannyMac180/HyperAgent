...
require_text CONTRIBUTING.md "sensing, verification, memory, safety, capability discovery, upgrade flow, and adapter boundary"
require_text CONTRIBUTING.md "Adapter-specific conveniences belong"
...
require_text .github/pull_request_template.md "Suit Not Scaffold gate is answered"
...
require_text docs/roadmap.md "adapter-specific conveniences"
...
require_text evals/smoke-loop.sh "strict mission verification accepted placeholder mission"
require_text evals/smoke-loop.sh "closeout missing sense snapshot"
require_text evals/smoke-loop.sh "closeout did not update requested mission"
...
require_text templates/mission-record.md "Sense snapshot"
...
require_text templates/upgrade-proposal.md "Suit Not Scaffold Review"
require_text templates/upgrade-proposal.md "Durable-agency pillar strengthened"
require_text templates/upgrade-proposal.md "Feature home"
